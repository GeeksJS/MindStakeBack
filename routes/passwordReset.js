    ...
    try {
        ...
        <body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
         ...
         padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                <a class="mcnButton " href="https://mindstake.vercel.app/reset-password" style="mso-line-height-rule: exactly;
        ...
        `});
        res.json({ ResetPasswordUserId: user._id, ResetPasswordToken: token.token })
