...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="https://mindstake.vercel.app/activate-account" style="mso-line-height-rule: exactly;
...
router.post("/activate-account/:userId", async (req, res) => {
  try {
    ...
    res.send("account activated sucessfully.");
  } catch (error) {
